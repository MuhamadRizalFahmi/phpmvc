                ...
                <?php foreach ($data['jurusan'] as $jurusan) : ?>
                    <li class="list-group-item d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="<?= BASEURL; ?>/jurusan/detail/<?= $jurusan['id']; ?>" class="btn btn-primary float-right">detail</a>
                            <a href="<?= BASEURL; ?>/jurusan/hapus/<?= $jurusan['id']; ?>" class="btn btn-danger float-right" onclick="return confirm('yakin?');">hapus</a>
                            <a href="<?= BASEURL; ?>/jurusan/ubah/<?= $jurusan['id']; ?>" class="btn btn-success float-right tampilModalUbah" data-toggle="modal" data-target="#formModal" data-id="<?= $jurusan['id']; ?>">ubah</a>
                            <a href="<?= BASEURL; ?>/jurusan/detail/<?= $jurusan['id']; ?>" class="badge badge-primary float-right">detail</a>
                        </div>
                    </li>
                <?php endforeach; ?>
            </ul>
